/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0c8fceaf53332f39908ec8d8c448033)
// Runtime types generated with workerd@1.20250705.0 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		LOCAL_CLERK_PUBLISHABLE_KEY: string;
		LOCAL_CLERK_SECRET_KEY: string;
		LOCAL_OPENAI_SECRET_KEY: string;
		db: D1Database;
		CLERK_PUBLISHABLE_KEY: SecretsStoreSecret;
		CLERK_SECRET_KEY: SecretsStoreSecret;
		OPENAI_SECRET_KEY: SecretsStoreSecret;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOCAL_CLERK_PUBLISHABLE_KEY" | "LOCAL_CLERK_SECRET_KEY" | "LOCAL_OPENAI_SECRET_KEY">> {}
}
